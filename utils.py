...
def generate_broadcast_news(api_key, news_data, reddit_data, topics):
    """Generate broadcast news using Groq API"""
...
def summarize_with_groq_news_script(api_key: str, headlines: str) -> str:
    """
    Summarize multiple news headlines into a TTS-friendly broadcast news script using Groq API.
    """
    system_prompt = """
...
"""
    ...
    try:
        ...
        # Invoke Groq with system + user prompt
        response = llm.invoke([
            SystemMessage(content=system_prompt),
